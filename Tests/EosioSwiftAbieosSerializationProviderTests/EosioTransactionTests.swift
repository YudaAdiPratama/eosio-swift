...
class EosioTransactionTests: XCTestCase {
    ...
    func testSerializeActionData() {
        do {
            ...
            try transaction.abis.addAbi(name: try EosioName("vex.token"), base64: tokenAbiB64)
            try transaction.abis.addAbi(name: try EosioName("vexcore"), base64: eosioAbiB64)
    ...
    func testToEosioTransactionRequest() {
        do {
            ...
            try transaction.abis.addAbi(name: EosioName("vex.token"), base64: tokenAbiB64)
    ...
    func testGetAbis() {
        ...
        transaction.getAbis { [weak self] (result) in
            ...
            case .success:
                XCTAssertEqual(try? self.transaction.abis.hashAbi(name: EosioName("vex.token")), "43864d5af0fe294d44d19c612036cbe8c098414c4a12a5a7bb0bfe7db1556248")
                XCTAssertEqual(try? self.transaction.abis.hashAbi(name: EosioName("vexcore")), "d745bac0c38f95613e0c1c2da58e92de1e8e94d658d64a00293570cc251d1441")
                expect.fulfill()
            }
        }
        wait(for: [expect], timeout: 3)
